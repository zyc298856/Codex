...
static int net_Socket( int i_family, int i_socktype,
                       int i_protocol )
{
    int fd, i_val;
 ...
 *****************************************************************************/
int *__net_ListenTCP(const char *psz_host, int i_port )
{
    struct addrinfo hints, *res, *ptr;
...
int __net_WriteNonBlock( int fd, 
